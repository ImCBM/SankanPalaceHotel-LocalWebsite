            ...
            <div class="col-md-4 mb-4">
                <div class="card room-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="room-features">
                            <li><i class="fas fa-bed"></i> Premium King Bed</li>
            ...
            <div class="col-md-4 mb-4">
                <div class="card room-card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="room-features">
                            <li><i class="fas fa-home"></i> Separate Living Area</li>
            ...
            <div class="col-md-6 mb-4">
                <div class="offer-card">
                    <div class="offer-content">
                        ...
                        <p>Stay 3-5 days and get 10% off with cash payment</p>
                        <a href="reservation.php" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="offer-card">
                    <div class="offer-content">
                        ...
                        <p>Stay 6 days or more and enjoy 15% off with cash payment</p>
                        <a href="reservation.php" class="btn btn-primary">Book Now</a>
                    </div>
                </div>
            </div>
